...
async function createRegistration(req, res) {
  try {
    ...
    // course_date_id comes from hidden input updated by JS; fall back to the select value
    const raw_date_id = req.body.course_date_id || req.body.preferred_date_select;
    ...
    const sanitized = {
      ...
      course_date_id: (raw_date_id && raw_date_id !== 'other') ? parseInt(raw_date_id, 10) || null : null,
